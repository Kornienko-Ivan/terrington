...
function cptui_register_my_cpts_products() {
    ...
    $labels = [
        "name" => esc_html__( "Products", "terrington" ),
        "singular_name" => esc_html__( "Products", "terrington" ),
    ];

    $args = [
        "label" => esc_html__( "Products", "terrington" ),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
...
function cptui_register_my_cpts_brochures() {
    ...
    $labels = [
        "name" => esc_html__( "Brochures", "terrington" ),
        "singular_name" => esc_html__( "Brochures", "terrington" ),
    ];

    $args = [
        "label" => esc_html__( "Brochures", "terrington" ),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
